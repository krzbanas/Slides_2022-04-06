...
.pull-right[ 
```{r, ,  echo=FALSE}
knitr::include_graphics("img/single_spectra.png")
```
]
...
.pull-right[ 
```{r, ,  echo=FALSE}
knitr::include_graphics("img/imaging.png")
```
]
...
.pull-right[ 
```{r, ,  echo=FALSE}
knitr::include_graphics("img/hyperspectra.png")
```
]
...
.pull-right[ 
```{r, ,  echo=FALSE}
knitr::include_graphics("img/hyperspectra2.png")
```
]

---
## Single cell analysis - FTIR
```{r, echo=FALSE,  out.width = "80%"}
knitr::include_graphics("img/single_cell_FTIR.png")
```

---
## Single cell analysis - FTIR versus OPTIR
```{r, echo=FALSE,  out.width = "80%"}
knitr::include_graphics("img/single_cell_FTIR_OPTIR.png")
```
...
```{r, echo=FALSE,  out.width = "80%"}
knitr::include_graphics("img/amide1.png")
```
...
```{r, echo=FALSE,  out.width = "80%"}
knitr::include_graphics("img/amide1_peak_shift.png")
```
...
```{r, echo=FALSE,  out.width = "80%"}
knitr::include_graphics("img/hemozoin_boxplot.png")
```

---
## Hemozoin Violin Plot

```{r, echo=FALSE,  out.width = "80%"}
knitr::include_graphics("img/hemozoin.png")
```

---
## Hemozoin Violin Plot with Statistical Tests

```{r, echo=FALSE,  out.width = "80%"}
knitr::include_graphics("img/hemozoin_with_tests.png")
```
...
```{r, echo=FALSE,  out.width = "80%"}
knitr::include_graphics("img/test_reading.png")
```
---
class: center, middle
...
- single cells infrared characterization is not recommended with classic FTIR microscope due to diffraction limit
